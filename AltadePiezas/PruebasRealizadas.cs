...
namespace AltadePiezas
{
    public partial class PruebasRealizadas : Form
    {
        ...
        {
            string[] sciclo = comboBoxCiclos.SelectedItem.ToString().Split('|');
            int ciclo = Convert.ToInt32(sciclo[1]);
            List<int> lotes = lote.ObtenerPorCiclo(ciclo);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                serie = comboBoxSerie.SelectedItem.ToString();
            ...
            if (respuesta == DialogResult.Yes)
            {
                foreach (var item in listBox1.Items)
                {
                    ...
                    prueba.Insertar(fecha, pkSerie, pruebaR, aprobada, defecto);
                }
